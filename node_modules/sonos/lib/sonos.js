...
/**
* Fetches metadata associated with the current URI parsed neatly.
*/
Sonos.prototype.getCurrentUriMetadata = async function () {
  mediaInfo = await this.avTransportService().GetMediaInfo()
  metadata = mediaInfo.CurrentURIMetaData
  xml = await Helpers.ParseXml(metadata)
  didl = Helpers.ParseDIDL(xml)
  return didl
}
